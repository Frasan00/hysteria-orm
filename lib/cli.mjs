...
var require_create_require = __commonJS({
  "node_modules/create-require/create-require.js"(exports, module) {
    ...
    function isDir(path5) {
      try {
        const stat = fs3.lstatSync(path5);
...
var require_node_internalBinding_fs = __commonJS({
  "node_modules/ts-node/dist-raw/node-internalBinding-fs.js"(exports, module) {
    ...
    function internalModuleReadJSON(path4) {
      let string;
      try {
        string = fs3.readFileSync(path4, "utf8");
      } catch (e) {
    ...
    function internalModuleStat(path4) {
      const stat = fs3.statSync(path4, { throwIfNoEntry: false });
      if (!stat) return -1;
...
var require_node_internal_modules_cjs_loader = __commonJS({
  "node_modules/ts-node/dist-raw/node-internal-modules-cjs-loader.js"(exports, module) {
    ...
    var { pathToFileURL, fileURLToPath: fileURLToPath2 } = __require("url");
    var fs3 = __require("fs");
    var path4 = __require("path");
    var { sep } = path4;
    ...
    function createCjsLoader(opts) {
      ...
      function finalizeEsmResolution(resolved, parentPath, pkgPath) {
        ...
        const filename = fileURLToPath2(resolved);
...
var require_acorn = __commonJS({
  "node_modules/ts-node/node_modules/acorn/dist/acorn.js"(exports, module) {
    "use strict";
    init_esm_shims();
  ...
  "node_modules/@cspotcode/source-map-support/node_modules/@jridgewell/trace-mapping/dist/trace-mapping.umd.js"(exports, module) {
    ...
    (function(global2, factory) {
      ...
      (() => {
        ...
        exports2.traceSegment = (map, line, column2) => {
          const decoded = exports2.decodedMappings(map);
          if (line >= decoded.length)
            return null;
          return traceSegmentInternal(decoded[line], map._decodedMemo, line, column2, GREATEST_LOWER_BOUND);
        };
        exports2.originalPositionFor = (map, { line, column: column2, bias }) => {
          line--;
          if (line < 0)
        ...
        exports2.generatedPositionFor = (map, { source, line, column: column2, bias }) => {
          line--;
          if (line < 0)
            throw new Error(LINE_GTR_ZERO);
          if (column2 < 0)
      ...
      try {
        ...
        if (path4.isAbsolute(file)) {
          ...
          if (isSchemeRelativeUrl(url)) {
            return fileURLToPath2(new URL(url, "file://"));
          }
    ...
    function matchStyleOfPathOrUrl(matchStyleOf, pathOrUrl) {
      try {
        if (isAbsoluteUrl(matchStyleOf) || isSchemeRelativeUrl(matchStyleOf)) {
          ...
          if (path4.isAbsolute(pathOrUrl)) return pathToFileURL(pathOrUrl).toString();
        } else if (path4.isAbsolute(matchStyleOf)) {
          if (isAbsoluteUrl(pathOrUrl) || isSchemeRelativeUrl(pathOrUrl)) {
            return fileURLToPath2(new URL(pathOrUrl, "file://"));
          }
        }
        return pathOrUrl;
      } catch (e) {
...
var require_node_internal_modules_esm_resolve = __commonJS({
  "node_modules/ts-node/dist-raw/node-internal-modules-esm-resolve.js"(exports, module) {
    ...
    var { URL: URL2, pathToFileURL, fileURLToPath: fileURLToPath2 } = __require("url");
    var {
    ...
    function createResolve(opts) {
      ...
      function emitFolderMapDeprecation(match, pjsonUrl, isExports, base) {
        const pjsonPath = fileURLToPath2(pjsonUrl);
        ...
        process.emitWarning(
          `Use of deprecated folder mapping "${match}" in the ${isExports ? '"exports"' : '"imports"'} field module resolution of the package at ${pjsonPath}${base ? ` imported from ${fileURLToPath2(base)}` : ""}.
Update this package.json to use a subpath pattern like "${match}*".`,
      ...
      function fileExists(url) {
        return tryStatSync(fileURLToPath2(url)).isFile();
      }
      function legacyMainResolve(packageJSONUrl, packageConfig, base) {
        ...
        throw new ERR_MODULE_NOT_FOUND(
          fileURLToPath2(new URL2(".", packageJSONUrl)),
          fileURLToPath2(base)
        );
      }
      ...
      function finalizeResolution(resolved, base) {
        ...
        if (experimentalSpecifierResolution === "node") {
          const path5 = fileURLToPath2(resolved);
        ...
        const path4 = fileURLToPath2(file);
        const stats = tryStatSync(StringPrototypeEndsWith(path4, "/") ? StringPrototypeSlice(path4, -1) : path4);
        if (stats.isDirectory()) {
          const err = new ERR_UNSUPPORTED_DIR_IMPORT(path4, fileURLToPath2(base));
      ...
      function throwImportNotDefined(specifier, packageJSONUrl, base) {
        throw new ERR_PACKAGE_IMPORT_NOT_DEFINED(
          specifier,
          packageJSONUrl && fileURLToPath2(new URL2(".", packageJSONUrl)),
          fileURLToPath2(base)
        );
      }
      function throwExportsNotFound(subpath, packageJSONUrl, base) {
        throw new ERR_PACKAGE_PATH_NOT_EXPORTED(
          fileURLToPath2(new URL2(".", packageJSONUrl)),
          subpath,
          base && fileURLToPath2(base)
        );
      }
      function throwInvalidSubpath(subpath, packageJSONUrl, internal, base) {
        const reason = `request is not a valid subpath for the "${internal ? "imports" : "exports"}" resolution of ${fileURLToPath2(packageJSONUrl)}`;
        throw new ERR_INVALID_MODULE_SPECIFIER(
          subpath,
          reason,
          base && fileURLToPath2(base)
      ...
      function packageImportsResolve(name, base, conditions) {
        if (name === "#" || StringPrototypeStartsWith(name, "#/")) {
          ...
          throw new ERR_INVALID_MODULE_SPECIFIER(name, reason, fileURLToPath2(base));
        }
        let packageJSONUrl;
      ...
      function packageResolve(specifier, base, conditions) {
        ...
        let packageJSONPath = fileURLToPath2(packageJSONUrl);
        let lastPath;
        do {
          ...
          if (!stat.isDirectory()) {
            ...
            packageJSONPath = fileURLToPath2(packageJSONUrl);
            continue;
          }
        ...
        throw new ERR_MODULE_NOT_FOUND(packageName, fileURLToPath2(base));
      }
      ...
      function resolveAsCommonJS(specifier, parentURL) {
        try {
          const parent = fileURLToPath2(parentURL);
        ...
        try {
          ...
          if (error.code === "ERR_MODULE_NOT_FOUND" || error.code === "ERR_UNSUPPORTED_DIR_IMPORT") {
            if (StringPrototypeStartsWith(specifier, "file://")) {
              specifier = fileURLToPath2(specifier);
            }
...
${hint}`;
        ...
        if (isMain ? !preserveSymlinksMain : !preserveSymlinks) {
          const urlPath = fileURLToPath2(url);
...
var require_node_internal_modules_esm_get_format = __commonJS({
  "node_modules/ts-node/dist-raw/node-internal-modules-esm-get_format.js"(exports, module) {
    ...
    var { URL: URL2, fileURLToPath: fileURLToPath2 } = __require("url");
        ...
        if (parsed.protocol === "data:") {
          ...
          if (!format) {
            if (experimentalSpeciferResolution === "node") {
              ...
              throw new ERR_UNKNOWN_FILE_EXTENSION(ext, fileURLToPath2(url));
            }
          }
...
${diagnosticText}`);
    ...
    function register2(serviceOrOpts) {
...
function getOrCreateMigrationPath() {
  ...
  let currentPath = path2.resolve(process.cwd(), migrationPath);
  if (!fs.existsSync(currentPath)) {
    fs.mkdirSync(currentPath, { recursive: true });
  }
  return currentPath;
}
function migrationCreateConnector(name) {
  const migrationFolderPath = getOrCreateMigrationPath();
  const timestamp = (/* @__PURE__ */ new Date()).getTime();
  const migrationFileName = `${timestamp}_${name}.ts`;
  const migrationFilePath = path2.join(migrationFolderPath, migrationFileName);
  const migrationTemplate = migration_templates_default.basicMigrationTemplate();
...
var import_ts_node = __toESM(require_dist());
...
async function loadMigrationModule(absolutePath) {
  try {
    ...
    logger_default.error(`Error loading migration module: ${String(error)}`);
  }
  return null;
}
...
function findMigrationNames() {
  ...
  const migrationPath = path3.resolve(
    process.env.MIGRATION_PATH || "database/migrations"
  );
  const fullPathToMigrationPath = path3.resolve(
