...
// src/sql/migrations/columns/create_table/column_options_builder.ts
var Column_options_builder = class _Column_options_builder {
  ...
  nullable() {
    ...
    return new _Column_options_builder(
      this.table,
...
// src/sql/migrations/columns/create_table/column_type_builder.ts
var Column_type_builder = class {
...
// src/sql/migrations/columns/create_table/column_builder_connector.ts
var Column_builder_connector = class {
  constructor(table, queryStatements, partialQuery, sqlType) {
    this.table = table;
    this.queryStatements = queryStatements;
    this.partialQuery = partialQuery;
...
// src/sql/migrations/columns/alter_table/column_builder_alter.ts
import { DateTime } from "luxon";
var Column_builder_alter = class {
  constructor(table, queryStatements, partialQuery, sqlType) {
    this.table = table;
    this.queryStatements = queryStatements;
    this.partialQuery = partialQuery;
...
var Belongs_to = class extends Relation {
...
var Has_many = class extends Relation {
  constructor(relatedModel, columnName, foreignKey, options) {
    super(relatedModel, columnName, options);
...
var Has_one = class extends Relation {
  constructor(relatedModel, columnName, foreignKey, options) {
    super(relatedModel, columnName, options);
    this.foreignKey = foreignKey;
...
var Mysql_query_builder = class _Mysql_query_builder extends Query_builder {
  /**
   * @param table - The name of the table.
  ...
  whereBuilder(cb) {
    const queryBuilder = new _Mysql_query_builder(
      this.model,
      this.table,
      this.mysqlConnection,
      this.logs,
  ...
  orWhereBuilder(cb) {
    const nestedBuilder = new _Mysql_query_builder(
      this.model,
      this.table,
      this.mysqlConnection,
      this.logs,
...
// src/sql/models/model_manager/abstract_model_manager.ts
var Abstract_model_manager = class {
  /**
   * @param model
   * @param logs
...
var ModelUpdateQueryBuilder = class extends Where_query_builder {
};

// src/sql/mysql/mysql_update_query_builder.ts
var Mysql_update_query_builder = class _Mysql_update_query_builder extends ModelUpdateQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Mysql_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Mysql_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
...
var ModelDeleteQueryBuilder = class extends Where_query_builder {
};

// src/sql/mysql/mysql_delete_query_builder.ts
var Mysql_delete_query_builder = class _Mysql_delete_query_builder extends ModelDeleteQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Mysql_delete_query_builder(
      this.model,
      this.model.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Mysql_delete_query_builder(
      this.model,
      this.model.table,
      this.sqlConnection,
      this.logs,
...
var Mysql_model_manager = class extends Abstract_model_manager {
  /**
   ...
   */
  query() {
    return new Mysql_query_builder(
      this.model,
      this.model.table,
      this.mysqlConnection,
      this.logs,
   ...
   */
  update() {
    return new Mysql_update_query_builder(
      this.model,
      this.model.table,
      this.mysqlConnection,
      this.logs,
   ...
   */
  deleteQuery() {
    return new Mysql_delete_query_builder(
      this.model,
      this.model.table,
      this.mysqlConnection,
      this.logs,
...
import "reflect-metadata";
var Postgres_query_builder = class _Postgres_query_builder extends Query_builder {
  ...
  whereBuilder(cb) {
    const queryBuilder = new _Postgres_query_builder(
      this.model,
      this.table,
      this.pgClient,
      this.logs,
  ...
  orWhereBuilder(cb) {
    const nestedBuilder = new _Postgres_query_builder(
      this.model,
      this.table,
      this.pgClient,
      this.logs,
...
var Postgres_update_query_builder = class _Postgres_update_query_builder extends ModelUpdateQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Postgres_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Postgres_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
...
var Postgres_delete_query_builder = class _Postgres_delete_query_builder extends ModelDeleteQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Postgres_delete_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Postgres_delete_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
...
var Postgres_model_manager = class extends Abstract_model_manager {
  /**
   ...
   */
  query() {
    return new Postgres_query_builder(
      this.model,
      this.model.table,
      this.pgConnection,
      this.logs,
   ...
   */
  update() {
    return new Postgres_update_query_builder(
      this.model,
      this.model.table,
      this.pgConnection,
      this.logs,
   ...
   */
  deleteQuery() {
    return new Postgres_delete_query_builder(
      this.model,
      this.model.table,
      this.pgConnection,
      this.logs,
...
var Sql_lite_query_builder = class _Sql_lite_query_builder extends Query_builder {
  /**
   * @param table - The name of the table.
  ...
  whereBuilder(cb) {
    const queryBuilder = new _Sql_lite_query_builder(
      this.model,
      this.table,
      this.sqLiteConnection,
      this.logs,
  ...
  orWhereBuilder(cb) {
    const nestedBuilder = new _Sql_lite_query_builder(
      this.model,
      this.table,
      this.sqLiteConnection,
      this.logs,
...
var Sql_lite_update_query_builder = class _Sql_lite_update_query_builder extends ModelUpdateQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Sql_lite_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Sql_lite_update_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
...
var Sql_lite_delete_query_builder = class _Sql_lite_delete_query_builder extends ModelDeleteQueryBuilder {
  /**
   * @description Constructs a Mysql_query_builder instance.
   * @param model - The model class associated with the table.
   * @param table - The name of the table.
   ...
   */
  whereBuilder(cb) {
    const queryBuilder = new _Sql_lite_delete_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
   ...
   */
  orWhereBuilder(cb) {
    const nestedBuilder = new _Sql_lite_delete_query_builder(
      this.model,
      this.table,
      this.sqlConnection,
      this.logs,
...
var Sql_lite_model_manager = class extends Abstract_model_manager {
  /**
   ...
   */
  query() {
    return new Sql_lite_query_builder(
      this.model,
      this.model.table,
      this.sqLiteConnection,
      this.logs,
   ...
   */
  update() {
    return new Sql_lite_update_query_builder(
      this.model,
      this.model.table,
      this.sqLiteConnection,
      this.logs,
   ...
   */
  deleteQuery() {
    return new Sql_lite_delete_query_builder(
      this.model,
      this.model.table,
      this.sqLiteConnection,
      this.logs,
...
// src/sql/sql_data_source.ts
var _Sql_data_source = class _Sql_data_source extends Datasource {
  constructor(input) {
    super(input);
  ...
  static async connect(input, cb) {
    ...
    _Sql_data_source.instance = sqlDataSource;
    cb?.();
  ...
  static getInstance() {
    ...
    return _Sql_data_source.instance;
  }
  /**
  ...
  async startTransaction(driverSpecificOptions) {
    const sqlDataSource = new _Sql_data_source({
      type: this.type,
      host: this.host,
      port: this.port,
  ...
  getModelManager(model) {
    ...
    switch (this.type) {
      case "mysql":
      case "mariadb":
        return new Mysql_model_manager(
          model,
          this.sqlConnection,
          this.logs,
          this
      ...
      case "postgres":
        return new Postgres_model_manager(
          model,
          this.sqlConnection,
          this.logs,
          this
      ...
      case "sqlite":
        return new Sql_lite_model_manager(
          model,
          this.sqlConnection,
          this.logs,
          this
  ...
  static async useConnection(connectionDetails, cb) {
    const customSqlInstance = new _Sql_data_source(connectionDetails);
  ...
  async closeConnection() {
    ...
    switch (this.type) {
      ...
      case "mariadb":
        await this.sqlConnection.end();
        this.isConnected = false;
        _Sql_data_source.instance = null;
        break;
      case "postgres":
        await this.sqlConnection.end();
        this.isConnected = false;
  ...
  static async rawQuery(query, params = []) {
    const sqlDataSource = _Sql_data_source.getInstance();
    if (!sqlDataSource || !sqlDataSource.isConnected) {
      throw new Error("sql database connection not established");
    }
    log(query, _Sql_data_source.getInstance()?.logs ?? false, params);
    switch (sqlDataSource.type) {
      case "mysql":
      case "mariadb":
...
_Sql_data_source.instance = null;
var Sql_data_source = _Sql_data_source;
...
var Model = class {
  ...
  static async softDelete(modelInstance, options) {
    ...
    if (typeof value === "string") {
      modelInstance[column2] = DateTime5.fromISO(value);
    }
    modelInstance[column2] = value;
    return await parseDatabaseDataIntoModelResponse(
      [modelInstance],
  ...
  static establishConnection() {
    const sql = Sql_data_source.getInstance();
    if (!sql) {
      throw new Error(
        "sql instance not initialized, did you defined it in Sql_data_source.connect static method?"
      );
    }
...
var Redis_data_source = class _Redis_data_source {
  ...
  static async connect(input) {
    ...
    const port = input?.port || +process.env.REDIS_PORT || 6379;
    _Redis_data_source.redisConnection = new Redis({
      host: input?.host || process.env.REDIS_HOST,
      username: input?.username || process.env.REDIS_USERNAME,
      port,
      password: input?.password || process.env.REDIS_PASSWORD,
