...
var Model = class {
  ...
  static insert(modelData, trx) {
    const typeofModel = this;
    const customConnection = typeofModel.checkCustomConnection(
      trx?.sqlDataSource
    );
    const modelManager = customConnection ? customConnection.getModelManager(typeofModel) : typeofModel.sqlInstance.getModelManager(typeofModel);
  ...
  static checkCustomConnection(sqlDataSource) {
    if (!sqlDataSource) {
      const typeofModel = this;
      typeofModel.establishConnection();
      return null;
