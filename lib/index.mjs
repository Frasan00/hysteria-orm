...
var Model = class {
  ...
  static async firstOrCreate(searchCriteria, createData, trx) {
    ...
    return await modelManager.create(createData, trx);
  }
  /**
  ...
  static async upsert(searchCriteria, data, options = {
    ...
    return await modelManager.create(data, options.trx);
  }
  /**
  ...
  static async upsertMany(searchCriteria, data, options = {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      results.push(await modelManager.create(record, options.trx));
    }
    return results;
  }
  /**
...
(async () => {
  ...
  console.log(updatedOrdInsertedMany);
