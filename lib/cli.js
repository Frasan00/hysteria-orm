...
async function loadMigrationModule(absolutePath) {
  ...
  if (isTs) {
    ...
    tsNode.register();
    const migrationModule2 = await require((0, import_node_url.fileURLToPath)(absolutePath));
    return migrationModule2.default;
  }
  const migrationModule = await import((0, import_node_url.fileURLToPath)(absolutePath));
