...
type ModelWithoutExtraColumns<T extends Model> = Omit<
  Partial<T>,
  "$additionalColumns"
>;
...
declare abstract class Model extends Entity {
  ...
  static all<T extends Model>(
    ...
    options?: BaseModelMethodOptions$1,
  ): Promise<T[]>;
  /**
  ...
  static first<T extends Model>(
    this: new () => T | typeof Model,
    options?: OneOptions$1 & BaseModelMethodOptions$1,
  ): Promise<T | null>;
  /**
...
declare class MongoQueryBuilder<T extends Collection> {
   ...
   * @returns
   */
  delete(options?: { ignoreHooks?: boolean }): Promise<void>;
  /**
   * @description Fetches the count of the query
   * @returns - The count of the query
   */
  count(options?: { ignoreHooks?: boolean }): Promise<number>;
...
declare class Collection extends Entity {
   ...
   * @param options
   */
  static find<T extends Collection>(
    this: new () => T | typeof Collection,
   ...
   * @param options
   */
  static findOne<T extends Collection>(
    this: new () => T | typeof Collection,
   ...
   * @returns {Promise<T>}
   */
  static findOneOrFail<T extends Collection>(
    this: new () => T | typeof Collection,
    options: MongoFindOneOptions<T> & BaseModelMethodOptions,
  ): Promise<T>;
  static findOneOrFail<T extends Collection>(
   ...
   * @returns {Promise<T>}
   */
  static insert<T extends Collection>(
    this: new () => T | typeof Collection,
    modelData: ModelKeyOrAny<T>,
    options?: BaseModelMethodOptions,
  ): Promise<T>;
   ...
   * @returns {Promise<T>}
   */
  static insertMany<T extends Collection>(
    this: new () => T | typeof Collection,
    modelData: ModelKeyOrAny<T>[],
    options?: BaseModelMethodOptions,
  ): Promise<T[]>;
   ...
   */
  static updateRecord<T extends Collection>(
    this: new () => T | typeof Collection,
    model: T,
    options?: BaseModelMethodOptions,
  ): Promise<T>;
   ...
   */
  static deleteRecord<T extends Collection>(
    this: new () => T | typeof Collection,
    model: T,
    options?: BaseModelMethodOptions,
  ): Promise<void>;
...
type MongoUnrestrictedFindManyOptions<T extends Collection> =
...
type MongoDataSourceInput = Exclude<
  DataSourceInput,
...
declare class MongoDataSource extends DataSource {
   ...
   * @description Executes a callback function with the provided connection details
   */
  static useConnection<T extends Collection>(
...
declare class StandaloneQueryBuilder {
  ...
  where(
    column: string,
    operatorOrValue: BinaryOperatorType$1 | BaseValues$1,
    value?: BaseValues$1,
  ): this;
  /**
   * @description Adds an AND WHERE condition to the query.
