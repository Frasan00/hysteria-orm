...
declare const selectTemplate: (
  dbType: SqlDataSourceType$1,
...
type UnrestrictedFindType<T> = Omit<
...
declare class Mysql_query_builder<T extends Model> extends Query_builder<T> {
  ...
  constructor(
    ...
    logs: boolean,
    isNestedCondition: boolean | undefined,
    sqlDataSource: SqlDataSource,
  );
  one(options?: OneOptions): Promise<T | null>;
  oneOrFail(options?: { ignoreHooks?: OneOptions["ignoreHooks"] }): Promise<T>;
  many(options?: ManyOptions): Promise<T[]>;
  getCount(options?: { ignoreHooks: boolean }): Promise<number>;
 ...
 */
type ModelQueryBuilder<T extends Model> =
  | Mysql_query_builder<T>
  | Postgres_query_builder<T>
  | Sql_lite_query_builder<T>;
...
declare abstract class ModelUpdateQueryBuilder<
  T extends Model,
...
declare abstract class ModelDeleteQueryBuilder<
  T extends Model,
> extends Where_query_builder<T> {
  protected abstract sqlConnection: SqlConnectionType;
  protected abstract joinQuery: string;
...
declare abstract class Model {
   ...
   */
  static upsertMany<T extends Model>(
    this: new () => T | typeof Model,
   ...
   * @returns
   */
  static softDelete<T extends Model>(
    this: new () => T | typeof Model,
    modelInstance: T,
    options?: {
      column?: string;
   ...
   * @returns
   */
  static addDynamicColumns<T extends Model>(
    this: new () => T | typeof Model,
...
declare class Mysql_update_query_builder<
  T extends Model,
...
declare class Mysql_delete_query_builder<
  T extends Model,
...
declare class Mysql_model_manager<
  T extends Model,
...
declare class Postgres_update_query_builder<
  T extends Model,
> extends ModelUpdateQueryBuilder<T> {
...
declare class Postgres_delete_query_builder<
  T extends Model,
> extends ModelDeleteQueryBuilder<T> {
  protected sqlConnection: Client;
  protected joinQuery: string;
...
declare class Postgres_model_manager<
  T extends Model,
> extends Abstract_model_manager<T> {
...
declare class Sql_lite_update_query_builder<
  T extends Model,
> extends ModelUpdateQueryBuilder<T> {
...
declare class Sql_lite_delete_query_builder<
  T extends Model,
> extends ModelDeleteQueryBuilder<T> {
  protected sqlConnection: sqlite3.Database;
  protected joinQuery: string;
...
declare class Sql_lite_model_manager<
  T extends Model,
> extends Abstract_model_manager<T> {
  protected sqLiteConnection: sqlite3.Database;
  protected sqlModelManagerUtils: SqlModelManagerUtils<T>;
