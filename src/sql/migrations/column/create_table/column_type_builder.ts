  ...
  implements IColumnTypeBuilder
{
  ...
  string(name: string, length: number = 255): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        ...
        this.partialQuery += ` ${quotedName} VARCHAR(${length})`;
        break;
      ...
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TEXT`;
        break;
      default:
        throw new HysteriaError(
  ...
  uuid(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "cockroachdb":
        ...
        this.columnName = name;
        this.partialQuery += ` ${quotedName} UUID`;
        break;
      case "mariadb":
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} CHAR(36)`;
        break;
      case "sqlite":
  ...
  autoGeneratedUUID(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "cockroachdb":
        ...
        this.columnName = name;
        this.partialQuery += ` ${quotedName} UUID DEFAULT uuid_generate_v4()`;
        break;
      case "mariadb":
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} CHAR(36) DEFAULT (UUID())`;
        break;
      case "sqlite":
        logger.warn("sqlite does not support UUID, using text instead");
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TEXT DEFAULT (hex(randomblob(16)))`;
        break;
      default:
        throw new HysteriaError(
  ...
  tinytext(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TINYTEXT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  mediumtext(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} MEDIUMTEXT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  longtext(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} LONGTEXT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  binary(name: string, length: number = 255): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} BINARY(${length})`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} BYTEA`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} BLOB(${length})`;
        break;
      default:
        throw new HysteriaError(
  ...
  enum(name: string, values: string[]): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} ENUM('${values.join("', '")}')`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TEXT CHECK(${name} IN ('${values.join(
          "', '",
        )}'))`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} VARCHAR(255) CHECK(${name} IN ('${values.join(
          "', '",
        )}'))`;
        break;
      default:
  ...
  char(name: string, length: number = 255): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} CHAR(${length})`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  tinyint(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TINYINT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} SMALLINT`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} TINYINT`;
  ...
  mediumint(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} MEDIUMINT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} INTEGER`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} MEDIUMINT`;
  ...
  serial(name: string): ColumnConstraints {
    ...
    if (this.sqlType === `mysql` || this.sqlType === `mariadb`) {
      this.columnName = name;
      this.partialQuery += ` ${quotedName} INT AUTO_INCREMENT`;
      return this.constraintsBuilder;
    }

    if (this.sqlType === `sqlite`) {
      this.columnName = name;
      this.partialQuery += ` ${quotedName} INTEGER PRIMARY KEY AUTOINCREMENT`;
      return this.constraintsBuilder;
    }

    this.columnName = name;
    this.partialQuery += ` ${quotedName} SERIAL`;
    return this.constraintsBuilder;
  }
  ...
  bigSerial(name: string): ColumnConstraints {
    ...
    if (this.sqlType === `mysql` || this.sqlType === `mariadb`) {
      this.columnName = name;
      this.partialQuery += ` ${quotedName} BIGINT AUTO_INCREMENT`;
      return this.constraintsBuilder;
    }
    ...
    this.columnName = name;
    this.partialQuery += ` ${quotedName} BIGSERIAL`;
    return this.constraintsBuilder;
  }
  ...
  integer(name: string, length?: number): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} INT ${length ? `(${length})` : ""}`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} INTEGER ${length ? `(${length})` : ""}`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} INTEGER ${length ? `(${length})` : ""}`;
  ...
  bigInteger(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} BIGINT`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  float(
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} FLOAT(${options.precision}, ${options.scale})`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} REAL`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} REAL`;
  ...
  decimal(
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} DECIMAL(${options.precision}, ${options.scale})`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
  ...
  double(
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} DOUBLE(${options.precision}, ${options.scale})`;
        break;
      case "postgres":
      case "cockroachdb":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} DOUBLE PRECISION`;
        break;
      case "sqlite":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} REAL`;
  ...
  boolean(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      ...
      case "mysql":
        this.columnName = name;
        this.partialQuery += ` ${quotedName} BOOLEAN`;
        break;
      ...
      case "sqlite":
        ...
        this.columnName = name;
        this.partialQuery += ` ${quotedName} INTEGER CHECK(${quotedName} IN (0, 1))`;
        break;
      default:
        throw new HysteriaError(
  ...
  date(
    ...
    this.columnName = name;
    this.partialQuery += ` ${quotedName} DATE`;
  ...
  timestamp(name: string, options?: DateOptions): ColumnConstraints {
    ...
    this.columnName = name;
    this.partialQuery += ` ${quotedName} ${this.sqlType === "postgres" || this.sqlType === "cockroachdb" ? "TIMESTAMP WITH TIME ZONE" : "TIMESTAMP"}`;
  ...
  jsonb(name: string): ColumnConstraints {
    ...
    switch (this.sqlType) {
      case "postgres":
      case "cockroachdb":
        this.partialQuery += ` ${quotedName} JSONB`;
        break;
      case "mariadb":
      case "mysql":
        this.partialQuery += ` ${quotedName} JSON`;
        break;
      case "sqlite":
        logger.warn(
