...
export class User extends Model {
    // Used only to set the table name, to retrieve the table name use User.table
    static tableName: string = "users"; // Default Class name lowercase, in snake case and in the plural form
