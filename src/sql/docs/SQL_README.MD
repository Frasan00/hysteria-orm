...
### Model with UUID
- While using auto generated uuids in mysql and sqlite, it's necessary to create the uuids before the insert operation via hook or manually, else the insert operation will not work as intended
