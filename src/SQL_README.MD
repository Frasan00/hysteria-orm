...
- IMPORTANT: bulk delete and updated resolve the list of affected models only if a primary key is present in the Model, else will always return an empty Array
