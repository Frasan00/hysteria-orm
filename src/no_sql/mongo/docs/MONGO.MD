...
- Every property queried that does not exist in the collection will be inserted in the `$additional` property that every collection has, so you can access it later if you want.
