...
export class MssqlUpdateQueryBuilder<
  T extends Model,
> extends ModelUpdateQueryBuilder<T> {
   ...
   */
  public whereBuilder(
    cb: (queryBuilder: MssqlUpdateQueryBuilder<T>) => void,
  ): this {
    const queryBuilder = new MssqlUpdateQueryBuilder(
    ...
    cb(queryBuilder as unknown as MssqlUpdateQueryBuilder<T>);
  ...
  public orWhereBuilder(
    ...
    const nestedBuilder = new MssqlUpdateQueryBuilder(
      this.model as typeof Model,
      this.table,
      this.sqlConnection,
      this.logs,
    ...
    cb(nestedBuilder as unknown as MssqlUpdateQueryBuilder<T>);
